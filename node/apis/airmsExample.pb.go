...
package apis // import "airman.com/airmsExample/node/apis"
...
func (*AirmsExampleRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_airmsExample_4de40cf754399f79, []int{0}
}
...
func (dst *AirmsExampleRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AirmsExampleRequest.Merge(dst, src)
}
...
func (*AirmsExampleReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_airmsExample_4de40cf754399f79, []int{1}
}
...
func (dst *AirmsExampleReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AirmsExampleReply.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("node/apis/airmsExample.proto", fileDescriptor_airmsExample_4de40cf754399f79)
}

var fileDescriptor_airmsExample_4de40cf754399f79 = []byte{
